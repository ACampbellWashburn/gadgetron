...
namespace Gadgetron{
  ...
  class EXPORTGADGETS_GPUPMRI gpuGenericSensePrepGadgetRegrid :
    public Gadget3< ISMRMRD::AcquisitionHeader, hoNDArray< std::complex<float> >, hoNDArray<float> >
  {
    
  public:
    GADGET_DECLARE(gpuGenericSensePrepGadgetRegrid);

    gpuGenericSensePrepGadgetRegrid();
    virtual ~gpuGenericSensePrepGadgetRegrid();
