...
namespace Gadgetron{
  ...
  class EXPORTGADGETS_GPUPMRI gpuGenericSensePrepGadgetIterate :
    public Gadget3< ISMRMRD::AcquisitionHeader, hoNDArray< std::complex<float> >, hoNDArray<float> >
  {
    
  public:
    GADGET_DECLARE(gpuGenericSensePrepGadgetIterate);

    gpuGenericSensePrepGadgetIterate();
    virtual ~gpuGenericSensePrepGadgetIterate();
