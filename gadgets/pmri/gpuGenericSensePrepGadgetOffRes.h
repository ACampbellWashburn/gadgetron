...
namespace Gadgetron{
  ...
  class EXPORTGADGETS_GPUPMRI gpuGenericSensePrepGadgetOffRes :
    public Gadget3< ISMRMRD::AcquisitionHeader, hoNDArray< std::complex<float> >, hoNDArray<float> >
  {
    
  public:
    GADGET_DECLARE(gpuGenericSensePrepGadgetOffRes);

    gpuGenericSensePrepGadgetOffRes();
    virtual ~gpuGenericSensePrepGadgetOffRes();
